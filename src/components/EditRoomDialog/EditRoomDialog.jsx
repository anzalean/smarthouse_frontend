...
import { updateRoom } from '../../redux/slices/homesSlice';

/**
 * Компонент діалогу для редагування існуючої кімнати
 */
const EditRoomDialog = ({ open, room, onClose, onSuccess }) => {
  ...
  // Оновлення форми при відкритті діалогу
  useEffect(() => {
    if (room) {
      setFormData({
        name: room.name || '',
  ...
  // Обробник подання форми - мемоізований
  ...
  }, [validateForm, dispatch, room?._id, formData, onSuccess]);

  // Закриття діалогу і очищення форми - мемоізоване
